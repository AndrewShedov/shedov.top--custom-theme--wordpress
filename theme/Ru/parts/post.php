<article id="post-<?php the_ID(); ?>" class="post">
   <a aria-label="посмотреть пост" class="post_all_link" href="<?php the_permalink(); ?>"></a>

<!-- post pin (SVG icon) -->
   <?php if ( is_sticky() ) : ?>
<div class="post_pin_icon_wrap">
   <div class="post_pin_icon">
            ...
            <div class="post__share_list_social_icons">
               ...
               <div class="post__share_list_social_icons__icon_wrap post__share_list_social_icons__telegram_icon">
                  ...
                  <a href="https://telegram.me/share/url?url=<?php the_permalink(); ?>"
                     onclick="window.open(this.href, this.title, ); return false" target="_parent" aria-label="ссылка на telegram">
                  </a>
               </div>
               <div class="post__share_list_social_icons__icon_wrap post__share_list_social_icons__vk_icon">
                  ...
                  <a href="http://vk.com/share.php?url=<?php the_permalink(); ?>" title=""
                     onclick="window.open(this.href, this.title, ); return false" target="_parent" aria-label="ссылка на VK">
                  </a>
               </div>
