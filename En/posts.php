	...
	c0,0.8-0.2,1.6-0.2,2.4c0,47.1,38.2,85.3,85.3,85.3s85.3-38.2,85.3-85.3S473.8,341.3,426.7,341.3z"/>
           ...
           <div class="entry_cell_share_list_wrap">
             <div class="entry_cell_share_list">
               ...
               <div class="entry_cell_share_list_twitter_wrap">
                 <a href="http://twitter.com/share?&url=<?php the_permalink() ?>" title=""
                   onclick="window.open(this.href, this.title, ); return false" target="_parent">
                   <div class="entry_cell_share_list_twitter">
               ...
               <div class="entry_cell_share_list_telegram_wrap">
                 <a href="https://telegram.me/share/url?url=<?php the_permalink() ?>" title=""
                   onclick="window.open(this.href, this.title, ); return false" target="_parent">
                   <div class="entry_cell_share_list_telegram">
               ...
               <div class="entry_cell_share_list_vk_wrap">
                 <a href="http://vk.com/share.php?url=<?php the_permalink() ?>" title=""
                   onclick="window.open(this.href, this.title, ); return false" target="_parent">
                   <div class="entry_cell_share_list_vk">
                     <i class="fab fa-vk"></i>
                     <p>VK
                     <p>
                   </div>
               ...
               <div class="entry_cell_share_list_link_wrap">
                 <div class="entry_cell_share_list_link">
                  ...
                  data-href="<?php the_permalink() ?>">
                     <div class="entry_cell_share_link">
