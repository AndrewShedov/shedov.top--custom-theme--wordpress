<div id="post-<?php the_ID(); ?>" class="entry_cell_wrap">
   <div class="entry_cell">
      <a aria-label="see post" class="entry_cell_all_link" href="<?php the_permalink() ?>"></a>
         ...
         <div class="entry_cell_image_wrap">
            <?php
               no_image()
                   ?>
         </div>
      ...
      <div class="categories_entry_thumbnail_wrap">
         <div class="categories_entry_thumbnail">
            <div class="categories_entry_thumbnail_title">
            </div>
      ...
      <div class="views_date_share_wrap">
         ...
         <div class="entry_cell_share_wrap">
            ...
            <div class="entry_cell_share_list">
               ...
               <div class="entry_cell_share_list_social_icons">
                  <a href="http://twitter.com/share?&url=<?php the_permalink() ?>"
                     onclick="window.open(this.href, this.title, ); return false" target="_parent">
                     <svg class="entry_cell_share_list_social_icons__x_icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 20 20" version="1.1" aria-label="X link">
                  ...
                  <a href="https://telegram.me/share/url?url=<?php the_permalink() ?>"
                     ...
                     <svg class="entry_cell_share_list_social_icons__telegram_icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 20">
                  ...
                  <a href="http://vk.com/share.php?url=<?php the_permalink() ?>" title=""
                     ...
                     <svg class="entry_cell_share_list_social_icons__vk_icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="3.3 3 13 13" version="1.1">
                  ...
                  <div class="entry_cell_share_link_copy_notification_wrap">
                     <div class="entry_cell_share_link_copy_notification">
                        <p>Copy</p>
                     </div>
                     <div class="entry_cell_share_link" data-href="<?php the_permalink() ?>">
                        <!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
                        <svg class="entry_cell_share_list_social_icons__share_link" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
