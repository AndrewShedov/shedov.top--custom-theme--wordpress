...
function my_menus() {
	$locations = array(
		...
		'head_menu' => __( 'Menu in header', 'my_menus' ),
...
// sorting posts by number of views 1 
 ...
 // sorting posts by number of views 2 
