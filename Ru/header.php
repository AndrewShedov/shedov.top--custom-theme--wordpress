    ...
    <div class="nav_wrap_0" id="nav_wrap_0">
      <div class="nav_0">
        <div class="header_logo_social_wrap">
          <div class="header_title"> <a href="https://shedov.top/ru">
              <div class="name">
                <p>ANDREW SHEDOV</p>
              </div>
            </a> </div>
          <div class="header_social_wrap" id="header_social_wrap">
            ...
            <a
                ...
                <div class="shadow telegram_icon_pro_svg_wrap"> <svg class="telegram_icon_pro_svg" width="24" height="24"
          ...
          <div class="mobile_header_adress_phone">
            <div class="mobile_header_social_wrap" id="mobile_header_social_wrap">
              <div class="mobile_header_social"> 
                <a href="https://t.me/AndrewShedovChannel" aria-label="telegram" target="_blank">
          ...
          <div class="mobile_1_search_open mobile_1_nav_search_input_wrap" id="mobile_1_search_open">
            <div class="mobile_1_nav_search_input_wrap_2">
              <form class="mobile_1_nav_search_input_wrap_3" role="search" method="get" id="mobile_searchform"
                action="<?php echo home_url( '/' ) ?>"> <label class="screen-reader-text">Поиск: </label> <input
                  class="mobile_1_nav_search_input" id="mobile_1_search_input_focus" type="text" value="" name="s"  autocomplete="off" 
                  ...
                  type="submit" id="mobile_searchsubmit" value="поиск" /> </form>
            </div>
          </div>
        </div>
      </div>
