			...
			<article id="div-comment-<?php comment_ID(); ?>" class="comment-body">
				<footer class="comment-meta">
					...
					<div class="comment-author vcard">
						...
						$comment2 = get_comment( $current_comment_id )->comment_author;
						...
						if ( twentynineteen_is_comment_by_post_author( $comment ) ) {
							printf( '<span class="post-author-badge" aria-hidden="true"><i class="fa fa-check check_author" aria-hidden="true"></i></span>');
						}
						...
						printf(
							...
							/*
							. 	'<div> Comment by : ' . $comment_author . '</div>'
*/
					...
					<div class="comment-metadata">
						...
						edit_comment_link( __( 'Edit', 'twentynineteen' ), ' <span class="edit-link-sep">&mdash;</span> <span class="edit-link"></span>' );
						?>
